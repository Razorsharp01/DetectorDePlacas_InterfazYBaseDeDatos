...
################################################################################
## Form generated from reading UI file 'interfazwCeXcO.ui'
##
...
"}")
        ...
        self.capturar_bt = QPushButton(self.visor_page)
        self.capturar_bt.setObjectName(u"capturar_bt")
        self.capturar_bt.setGeometry(QRect(260, 490, 150, 40))
        self.capturar_bt.setMinimumSize(QSize(150, 40))
        self.capturar_bt.setMaximumSize(QSize(150, 40))
...
"}")
        ...
        self.calcular_cobro_bt = QPushButton(self.base_page)
        self.calcular_cobro_bt.setObjectName(u"calcular_cobro_bt")
        self.calcular_cobro_bt.setGeometry(QRect(70, 540, 241, 51))
        self.calcular_cobro_bt.setStyleSheet(u"QPushButton{\n"
"background-color: rgb(255, 255, 255);\n"
"border-radius: 20px;\n"
"color: rgb(0,0,0);\n"
"font: 100 12pt\"Arial Black\";\n"
...
"font:100 12pt\"Arial Black\";\n"
"}")
        self.pago_hecho_bt = QPushButton(self.base_page)
        self.pago_hecho_bt.setObjectName(u"pago_hecho_bt")
        self.pago_hecho_bt.setGeometry(QRect(350, 540, 241, 51))
        self.pago_hecho_bt.setStyleSheet(u"QPushButton{\n"
"background-color: rgb(255, 255, 255);\n"
"border-radius: 20px;\n"
"color: rgb(0,0,0);\n"
"font: 100 12pt\"Arial Black\";\n"
...
"font:100 12pt\"Arial Black\";\n"
"}")
        self.actualizar_tabla_bt = QPushButton(self.base_page)
        self.actualizar_tabla_bt.setObjectName(u"actualizar_tabla_bt")
        self.actualizar_tabla_bt.setGeometry(QRect(910, 650, 241, 51))
        self.actualizar_tabla_bt.setStyleSheet(u"QPushButton{\n"
"background-color: rgb(255, 255, 255);\n"
"border-radius: 20px;\n"
"color: rgb(0,0,0);\n"
"font: 100 12pt\"Arial Black\";\n"
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.capturar_bt.setText(QCoreApplication.translate("MainWindow", u"Capturar", None))
        ...
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"Hora de entrada", None));
        ___qtablewidgetitem3 = self.tableWidget.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"Hora de salida", None));
        ___qtablewidgetitem4 = self.tableWidget.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", u"Monto de cobro", None));
        ___qtablewidgetitem5 = self.tableWidget.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("MainWindow", u"Pago", None));
        self.calcular_cobro_bt.setText(QCoreApplication.translate("MainWindow", u"Calcular cobro", None))
        self.pago_hecho_bt.setText(QCoreApplication.translate("MainWindow", u"Pago realizado", None))
        self.actualizar_tabla_bt.setText(QCoreApplication.translate("MainWindow", u"Actualizar tabla", None))
